...
import { FractalMemoryProvider } from "./fractalmemory"
...
const providers: Record<ProviderName, new () => Provider> = {
  ...
  rag: RAGProvider,
  fractalmemory: FractalMemoryProvider,
}
...
export { SupermemoryProvider, Mem0Provider, ZepProvider, FilesystemProvider, RAGProvider, FractalMemoryProvider }
